...
const COMPOSABLES_SUBPATH = '@docx-editor.dev/vue/composables';
const STYLES_SUBPATH = '@docx-editor.dev/vue/styles.css';

// Public composables re-exported by `@docx-editor.dev/vue/composables`.
...
export interface ModuleOptions {
   ...
   * Set to `false` to import `@docx-editor.dev/vue/styles.css` yourself.
   * Defaults to `true`.
   */
