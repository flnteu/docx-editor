...
- **AND** `LayoutCoordinator.updateSelection(selectionGeometry, caretPosition)` is called
...
The `LayoutCoordinator` class SHALL import only from `@docx-editor.dev/core` internals and vanilla DOM APIs. It SHALL NOT import React, Vue, or any framework.
