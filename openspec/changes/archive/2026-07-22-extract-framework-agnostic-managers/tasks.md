...
- [ ] 1.3 Export all manager types from `@docx-editor.dev/core`
...
- [ ] 7.3 Extract selection state (selectionGeometry, caretPosition, isDragging, dragAnchor) into the coordinator
